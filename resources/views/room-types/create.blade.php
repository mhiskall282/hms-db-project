<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="card">
            <h2 class="text-lg font-bold text-primary mb-4 pb-3 border-b border-gray-100">Create New Room Type</h2>
            ...
            <form method="POST" action="{{ route('room-types.store') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="e.g. Executive Deluxe" class="form-input">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" name="base_rate" id="base_rate" value="{{ old('base_rate') }}" required placeholder="0.00" class="form-input">
                    ...
                    <div>
                        ...
                        <input type="number" min="1" max="20" name="capacity" id="capacity" value="{{ old('capacity', 2) }}" required class="form-input">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3" placeholder="Describe room features and amenities..." class="form-textarea">{{ old('description') }}</textarea>
